...
final class ZorvianSidebar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final modules = ref.watch(filteredModulesProvider(role));
    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          ...
          // ── Divider ──
          if (!collapsed && modules.isNotEmpty)
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: ZSpacing.lg),
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(
          horizontal: collapsed ? ZSpacing.sm : ZSpacing.lg,
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.history, size: 12, color: isDark ? ZColors.neutral400 : ZColors.neutral500),
              const SizedBox(width: ZSpacing.xs),
              Text(
                'RECIENTES',
                style: ZTypography.labelSmall.copyWith(
