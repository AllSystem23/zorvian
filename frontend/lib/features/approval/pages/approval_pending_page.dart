...
final class _ApprovalPendingPageState extends ConsumerState<ApprovalPendingPage> {
  ...
  Future<void> _act(String id, String action) async {
    try {
      ...
      if (mounted) ZToast.error(context, 'Error al $action: $e');
    }
  }
